...
5. Follow the [Bear Extruder And X Axis Assembly - X axis](https://guides.bear-lab.com/Guide/2.+X+axis/3) to build the X axis.
   * Note: Lubricate linear bearings before installation
6. Follow the [Prusa i3 Bear Full Upgrade MK3 Assembly Instruction](https://github.com/gregsaun/prusa_i3_bear_upgrade/blob/master/full_upgrade/for_mk3/manual/assembly_instructions.md) steps 11 - 13 to install Z motors and Z rods (320 mm), mount the X axis, and Y tops
